...
(custom-set-variables
 ...
 '(package-selected-packages
   '(no-littering projectile magit-todos dockerfile-mode ayu-theme zygospore hide-mode-line vterm magit yasnippet ccls treemacs-all-the-icons treemacs company lsp-mode flycheck counsel counsel-mode marginalia ivy-prescient prescient all-the-icons-ivy-rich ivy-rich swiper ivy solaire-mode centaur-tabs doom-modeline doom-themes evil-collection evil use-package)))
(custom-set-faces
